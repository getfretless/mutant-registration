...
class MutantsControllerTest < ActionController::TestCase
  ...
  test "should create mutant" do
    assert_difference('Mutant.count') do
      post :create, mutant: { age: @mutant.age, name: @mutant.name, power: @mutant.power, real_name: @mutant.real_name }
    end
  ...
  test "should update mutant" do
    patch :update, id: @mutant, mutant: { age: @mutant.age, name: @mutant.name, power: @mutant.power, real_name: @mutant.real_name }
    assert_redirected_to mutant_path(assigns(:mutant))
  end
